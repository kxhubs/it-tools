  ...
  <div max-w-600px>
    <c-card :title="t('tools.regex-tester.regex')" mb-1>
      <c-input-text
        ...
        :placeholder="t('tools.regex-tester.regexToTestPlaceholder')"
        multiline
        rows="3"
      ...
      <n-space>
        <n-checkbox v-model:checked="global">
          <span :title="t('tools.regex-tester.globalSearchTitle')">{{ t('tools.regex-tester.globalSearch') }} (<code>g</code>)</span>
        </n-checkbox>
        <n-checkbox v-model:checked="ignoreCase">
          <span :title="t('tools.regex-tester.caseInsensitiveTitle')">{{ t('tools.regex-tester.caseInsensitive') }} (<code>i</code>)</span>
        </n-checkbox>
        <n-checkbox v-model:checked="multiline">
          <span :title="t('tools.regex-tester.multilineTitle')">{{ t('tools.regex-tester.multiline') }}(<code>m</code>)</span>
        </n-checkbox>
        <n-checkbox v-model:checked="dotAll">
          <span :title="t('tools.regex-tester.singlelineTitle')">{{ t('tools.regex-tester.singleline') }}(<code>s</code>)</span>
        </n-checkbox>
        <n-checkbox v-model:checked="unicode">
          <span :title="t('tools.regex-tester.unicodeTitle')">{{ t('tools.regex-tester.unicode') }}(<code>u</code>)</span>
        </n-checkbox>
        <n-checkbox v-model:checked="unicodeSets">
          <span :title="t('tools.regex-tester.unicodeSetsTitle')">{{ t('tools.regex-tester.unicodeSets') }} (<code>v</code>)</span>
        </n-checkbox>
      </n-space>
      ...
      <c-input-text
        ...
        :placeholder="t('tools.regex-tester.textToMatchPlaceholder')"
        multiline
        rows="5"
      />
    </c-card>
