...
<template>
  <div flex flex-col gap-4>
    ...
    <div flex gap-2>
      ...
      />
      <c-select
        v-model:value="encoding" :label="t('tools.hmac-generator.encodingLabel')"
        flex-1
        ...
        :options="[
          ...
          {
            label: t('tools.hmac-generator.encodingHexadecimal'),
            value: 'Hex',
          },
          {
    ...
    <input-copyable v-model:value="hmac" type="textarea" :placeholder="t('tools.hmac-generator.resultPlaceholder')" :label="t('tools.hmac-generator.resultLabel')" />
