...
<template>
  <div>
    <c-card>
      ...
      <n-form-item :label="t('tools.token-generator.deniedCharsLabel')" label-placement="top">
        <c-input-text
          v-model:value="deniedChars"
          :placeholder="t('tools.token-generator.deniedCharsPlaceholder')"
        />
      </n-form-item>
      ...
      <n-form-item :label="t('tools.token-generator.countLabel')" label-placement="left">
