...
<template>
  <div style="flex: 0 0 100%">
    <div mx-auto max-w-600px>
      <c-file-upload :title="t('tools.pdf-signature-checker.fileUploadTitle')" accept=".pdf" @file-upload="onVerifyClicked" />
      ...
      <div v-if="status === 'error'">
        <c-alert mt-4>
          {{ t('tools.pdf-signature-checker.noSignaturesFound') }}
        </c-alert>
      </div>
    </div>
  </div>
